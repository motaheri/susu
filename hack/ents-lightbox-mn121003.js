/* make the box office items title scroll up on hover */
$(document).ready(function(){
	$('.msl-boxoffice-item').hover(function(){
		$(this).find('.msl-boxoffice-item-title').animate({bottom: '0'}, {duration:300});
	}, function(){
		$(this).find('.msl-boxoffice-item-title').animate({bottom: '-60'}, {duration:300});
	});
});

/* Toby Hughes' lightbox code */
